...
class Bddi extends Component {
    ...
    state = {
        ...
        explicationWordCollection: [
            "Place à Paris où les BDDI se retrouvent pour jouir d’un happy hour du tonnerre de dieu.",
            "Boisson alcoolisé prises par les étudiants de cette promotion de manière régulière.",
            "Professeur présent durant 2 semaines consécutives pour l’apprentissage de React. XXXX, ça va ?",
            "C’est le moyen de communication de notre promotion. ",
            "Lieu de consommation excessivement gras mais pas cher grâce à une promotion : 2 bestOf pour le prix d’un ! PS : demander à Luc",
            "Sport souvent pratiqué durant les pauses des développeurs",
            "Coque de téléphone assez réputée pour sa solidité",
            "Setagang est le surnom donné à Seta"
        ],
        currentWord: null,
        //Keyboard
            ...
            <div>
                {this.state.levelType === "bddi" ? (
                    <div id="game">
                        ...
                        {this.state.currentWord === null && <h1>BDDI</h1>}
                        {this.state.currentWord === null && (
                            <p className="descriptionMode">
                                Yo ! Ici tu pourras retrouver l'ensemble des
                                mots utilisés par les élèves de notre classe.
                                Que l'esprit BDDI soit avec vous.
                            </p>
                        )}
