...
class Hardcore extends Component {
    ...
    state = {
        //liste de mots
        wordCollection: ["interdepartementalisation","hexakosioihexekontahexaphobie", "glycosylphosphatidylethanolamine", "orthochlorobenzalmalonitrile", "dichlorodiphenyltrichloroethane", "aminomethylpyrimidinylhydroxyethylmethythiazolium", "hippopotomonstrosesquippedaliophobie","cyclopentanoperhydrophenanthrene","apopathodiaphulatophobie","deconstitutionnaliseraient"],
        //liste de mots
            ...
            <div>
                {this.state.levelType === "hardcore" ? (
                    <div id="game">
                        ...
                        {
                            (this.state.currentWord === null) &&
                            <p>Cher visiteur de notre site, bienvenue dans le mode Hardcore. Sachez que si vous réussissez ce jeu du pendu, une place dans le paradis du monde de la langue française vous sera attribué. Que la culture soit avec vous. </p>
